...
#define SET_PROGRESS_MANUALLY
  ...
  #define M73_REPORT_AND_SUPPORT_GCODE
...
#define LIN_ADVANCE
  ...
  #else
    #define ADVANCE_K 0.012        // (mm) Compression length applying to all extruders
  #endif
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_LENGTH    89  // (mm) Load length of filament, from extruder gear to nozzle.
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
